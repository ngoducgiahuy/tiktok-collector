...
public abstract class AbstractService {
	...
	public JSONObject getData(String path, String accessToken, Long advertiserId, int page, int pageSize,
			String fields) {
		String myArgs = String.format(
				"{\"advertiser_id\": \"%s\", \"fields\": [%s], \"page\": \"%s\", \"page_size\": \"%s\"}", advertiserId,
